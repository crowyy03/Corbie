...
public enum CorbieModel {
    ...
    public static func build() -> NSManagedObjectModel {
        ...
        space.attribute("displayCurrency", .stringAttributeType, defaultValue: SupportedCurrencies.defaultCode)
        space.attribute("productionSubscriptionStatusRaw", .stringAttributeType, defaultValue: SubscriptionStatus.none.rawValue)
        space.attribute("productionSubscriptionExpiresAt", .dateAttributeType)
        ...
        plan.attribute("currency", .stringAttributeType, defaultValue: SupportedCurrencies.defaultCode)
