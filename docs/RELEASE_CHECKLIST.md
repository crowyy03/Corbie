...
On 2026-09-06 that reads: three gates ok, 473 core tests, 111 server tests, both builds succeeded,
245 app tests, and `Executed 39 tests, with 1 test skipped and 0 failures` for the UI suite. The
